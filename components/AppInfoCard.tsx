...
import { Globe, Database, Brain, Server } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Deployed to every one of Cloudflares 330+ locations in a single click",
    },
    {
      icon: Database,
      title: "Vectorize",
      description: "Vectorize is a globally distributed vector database that enables you to build full-stack, AI-powered applications with Cloudflare Workers.",
    },
    {
      icon: Brain,
      title: "Workers AI",
